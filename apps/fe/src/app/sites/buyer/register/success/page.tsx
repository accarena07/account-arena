        ...
        <div className="relative flex flex-col items-center justify-center bg-white p-8 text-center dark:bg-slate-900 lg:w-7/12 lg:p-16">
          ...
          <div className="mx-auto w-full max-w-md">
            <div className="relative mb-8">
              <div className="relative mx-auto mb-6 flex h-32 w-32 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30">
                ...
                <span className="material-symbols-outlined absolute -top-2 -right-2 animate-bounce text-secondary">
                  star
                </span>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 opacity-20 grayscale dark:invert">
            <Image
              ...
              height={32}
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuC5V8jr1q6bZWKwJuxcX38JnoaRT5M85ypggGB9cWOdblzj2KFBR9sxchG8pY4z69l4b5JsbbusQp0kH2AM67NzKIEcpb2sSbQBTd3Yl8_4FaSXngPfiDhr3RozKQ5fT9dVP8qA3za69hOM1AY2qi7WPdhwju_bIrP1czry_v6cDBttXaIVdja4Qn-U8FwBJXbIAfNPDl0YC5eZStLOrz6-BKN8DYIr3XbG-6Hwci6S5UHn8JgspOHIF2kYZePdXP1uqeQ-ntuoVT50"
              width={32}
            />
            <Image
              alt="gaming icon"
              className="h-8 w-8 opacity-50"
              height={32}
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuCeNbD_owIdRPUpTjhvoRF7CqORYUJTqyfKCIwbUkx8OTY_J0bFe2cPwLdla7wAXTYo-sE-17WYxKsdXPwOs0PqmQgQNxgqxuMrlakmzolHPzIo25zeZCrzxV-t78xsT7ve9kKVy-hOGBNitzyLzKUFM8CRepU2At7Ctb77-U31eFnrok3v9vawEOjeAZ0Aw7_nCjht-7pLcRXaBviYi8Xgx84wdYlh6iD_UTjGIxMJ0-fYlfoTfqup_O0QIUyZOzqUr4r5-Aaumsgk"
              width={32}
            />
            <Image
              alt="gaming icon"
              className="h-8 w-8 opacity-50"
              height={32}
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDCFMfHpLCgn7Gz9_MCtECnMb3i0E9kYq4vev1e1Q8pfe3VE2jrHSfu_aeXKIdLMoI5o2w5Mfk_HEsk_igMEV0qBoFoBSPKWOcq82djpdVqbKApK8LJW26j-KHTz1vGy_HOZCnLZa84-ps74R83auGWyqvzMv7LQgKarSkuClzKyHMpOKA2RwA3tJmSuplBt503Tdc075p_lc1M5IigOTWhUTTZ7IHu9bz4FGz49kGOBReKTB1to8vRkQuHXlt41QO1QV2ScVLsS4ea"
              width={32}
            />
          </div>
        </div>
